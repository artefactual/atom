...
class sfI18nApplicationExtract extends sfI18nExtract
{
  ...
  public function configure()
  {
    ...
    // Force application message source, so we don't load all the plugin i18n data yet
    $this->i18n->setMessageSource(array(sfConfig::get('sf_app_i18n_dir')), $this->culture);

...
<?php slot('title'); ?>
  <h1><?php echo __('Are you sure you want to delete %1%?', ['%1%' => render_title($group)]); ?></h1>
<?php end_slot(); ?>
...
<?php slot('content'); ?>
  ...
  <?php echo $form->renderFormTag(url_for([$group, 'module' => 'aclGroup', 'action' => 'delete']), ['method' => 'delete']); ?>

...
class sfNobradePluginEditAction extends InformationObjectEditAction
{
  ...
  protected function earlyExecute()
  {
    ...
    $this->alternativeIdentifiersComponent = new InformationObjectAlternativeIdentifiersComponent($this->context, 'informationobject', 'alternativeIdentifiers'); //alternative reference code
    $this->alternativeIdentifiersComponent->resource = $this->resource;
    $this->alternativeIdentifiersComponent->execute($this->request);

    $this->eventComponent = new sfNobradePluginEventComponent($this->context, 'sfNobradePlugin', 'event'); //event - dates
    ...
    $this->publicationNotesComponent->execute($this->request, $options = array('type' => 'nobradePublicationNotes')); //publication notes
    ...
    $this->notesComponent->execute($this->request, $options = array('type' => 'nobradeNotes')); //general notes
    ...
    $this->archivistsNotesComponent->execute($this->request, $options = array('type' => 'nobradeArchivistsNotes')); //archivist's notes
  }

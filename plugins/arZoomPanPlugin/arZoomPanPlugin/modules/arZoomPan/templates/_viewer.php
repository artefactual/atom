...
$isImage = 0 === strpos($mimeType, 'image/');
$isPdf = 'application/pdf' === $mimeType;
$isText = in_array($mimeType, ['text/plain', 'text/html', 'application/msword',
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  document.getElementById('<?php echo $viewerId; ?>-download').onclick = function() {
    window.location.href = '<?php echo url_for([$digitalObject, 'module' => 'digitalobject', 'action' => 'download']); ?>';
  };

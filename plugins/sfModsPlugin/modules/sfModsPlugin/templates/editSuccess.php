    ...
    <div id="main-column">
      ...
      <ul class="breadcrumb">
        <?php if (isset($sf_request->getAttribute('sf_route')->resource)): ?>
          ...
          <li><span><?php echo __('Edit %1% - MODS', array('%1%' => strtolower(sfConfig::get('app_ui_label_informationobject')))) ?></span></li>
        <?php else: ?>
          <li><span><?php echo __('Add new %1% - MODS', array('%1%' => strtolower(sfConfig::get('app_ui_label_informationobject')))) ?></span></li>
        <?php endif; ?>
      </ul>

...
class arUvicPluginConfiguration extends sfPluginConfiguration
{
  public static
  ...
  public function contextLoadFactories(sfEvent $event)
  {
    ...
    if ($context->getConfiguration()->isDebug())
    {
      ...
      $context->response->addStylesheet('/plugins/arUvicPlugin/css/main.less', 'last', array('rel' => 'stylesheet/less', 'type' => 'text/css'));
    }
    else
    {
      $context->response->addStylesheet('/plugins/arUvicPlugin/css/min.css', 'last', array('media' => 'screen'));
    }
  }

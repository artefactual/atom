    ...
    <controlaccess>
      <?php foreach ($resource->getActorEvents() as $event): ?>
        ...
        <?php elseif ($event->getActor()->getEntityTypeId() == QubitTerm::FAMILY_ID): ?>
          <famname role="<?php echo $event->getType()->getRole() ?>" id="atom_<?php echo $event->id ?>_actor"><?php echo escape_dc(esc_specialchars(render_title($event->getActor()))) ?></famname>
      ...
      <?php foreach ($place_events as $place): ?>
        <geogname role="<?php echo $place->getObject()->getType()->getRole() ?>" id="atom_<?php echo $event->id ?>_place"><?php echo escape_dc(esc_specialchars($place->getTerm())) ?></geogname>
      <?php endforeach; ?>
    </controlaccess>
  <?php endif; ?>
        ...
        if ((0 < count($materialtypes)) ||
          ...
          <controlaccess>
            ...
            <?php foreach ($descendant->getActorEvents() as $event): ?>
              <?php if ($event->getActor()->getEntityTypeId() == QubitTerm::PERSON_ID): ?>
                <persname role="<?php echo $event->getType()->getRole() ?>" id="atom_<?php echo $event->id ?>_actor" <?php if (0 < strlen($encoding = $ead->getMetadataParameter('actorEventsName'))): ?>encodinganalog="<?php echo $encoding ?>"<?php endif; ?>><?php echo escape_dc(esc_specialchars(render_title($event->getActor(array('cultureFallback' => true))))) ?> </persname>
              <?php elseif ($event->getActor()->getEntityTypeId() == QubitTerm::FAMILY_ID): ?>
                <famname role="<?php echo $event->getType()->getRole() ?>" id="atom_<?php echo $event->id ?>_actor" <?php if (0 < strlen($encoding = $ead->getMetadataParameter('actorEventsName'))): ?>encodinganalog="<?php echo $encoding ?>"<?php endif; ?>><?php echo escape_dc(esc_specialchars(render_title($event->getActor(array('cultureFallback' => true))))) ?> </famname>
              <?php else: ?>
                <corpname role="<?php echo $event->getType()->getRole() ?>" id="atom_<?php echo $event->id ?>_actor" <?php if (0 < strlen($encoding = $ead->getMetadataParameter('actorEventsName'))): ?>encodinganalog="<?php echo $encoding ?>"<?php endif; ?>><?php echo escape_dc(esc_specialchars(render_title($event->getActor(array('cultureFallback' => true))))) ?> </corpname>
              <?php endif; ?>
            <?php endforeach; ?>

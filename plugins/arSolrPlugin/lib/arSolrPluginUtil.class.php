...
class arSolrPluginUtil
{
    ...
    {
        // Load ES mappings
        $mappings = arSolrPlugin::loadMappings()->asArray();
    ...
    public static function getPremisData($ioId, $conn)
    {
        ...
        foreach ($row as $field => $value) {
            ...
            switch ($field) {
                case 'last_modified':
                    $premisData['lastModified'] = arSolrPluginUtil::convertDate($value);

                    break;

                case 'date_ingested':
                    $premisData['dateIngested'] = arSolrPluginUtil::convertDate($value);

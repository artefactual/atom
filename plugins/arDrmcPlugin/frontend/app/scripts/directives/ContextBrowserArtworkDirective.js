(function () {
  ...
  angular.module('drmc.directives').directive('arContextBrowserArtwork', function ($modal, SETTINGS, InformationObjectService, ModalLinkSupportingTechnologyService) {

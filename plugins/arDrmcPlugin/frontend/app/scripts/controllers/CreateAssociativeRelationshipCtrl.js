(function () {
  ...
  angular.module('drmc.controllers').controller('CreateAssociativeRelationshipCtrl', function ($scope, $modalInstance, InformationObjectService, TaxonomyService, id, source, target) {

(function () {
  ...
  angular.module('drmc.controllers').controller('SaveSearchCtrl', function ($scope, $rootScope, $state, $stateParams, $modalInstance, SETTINGS, id, criteria, entity, SearchService) {

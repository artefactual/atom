(function () {
  ...
  angular.module('drmc.controllers').controller('WorkViewCtrl', function ($scope, $state, $stateParams, $modal, $timeout, SETTINGS, InformationObjectService, ModalDigitalObjectViewerService, ModalDownloadService) {

(function () {
  ...
  angular.module('drmc.controllers').controller('EditDcMetadataCtrl', function ($scope, $state, $modalInstance, SETTINGS, InformationObjectService, ActorsService, TaxonomyService, id, parentId) {

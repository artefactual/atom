...
<?php slot('content'); ?>
  ...
  <?php } ?>
    ...
    <div class="accordion" id="deaccession-edit">
      <div class="accordion-item">
        ...
        <div id="deaccession-collapse" class="accordion-collapse collapse show" aria-labelledby="deaccession-heading" data-bs-parent="#deaccession-edit">

...
<?php slot('content'); ?>
  ...
  <?php } ?>
    ...
    <div class="accordion" id="dc-edit">
      <div class="accordion-item">
        ...
        <div id="elements-collapse" class="accordion-collapse collapse show" aria-labelledby="elements-heading" data-bs-parent="#dc-edit">
      ...
      <?php echo get_partial('informationobject/adminInfo', ['form' => $form, 'resource' => $resource, 'accordionId' => 'dc-edit']); ?>
    </div>

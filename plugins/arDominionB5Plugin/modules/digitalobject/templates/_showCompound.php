<div class="table-responsive mb-3">
  <table class="table table-bordered mb-0 compound_digiobj">
    <tbody>
      <tr>
        <td>
          <?php if (null !== $representation = $leftObject->getCompoundRepresentation()) { ?>
            <?php if ($resource->object->getRawValue() instanceof QubitInformationObject) { ?>
            ...
            <?php } elseif ($resource->object->getRawValue() instanceof QubitActor) { ?>
      ...
      <?php if (($resource->object->getRawValue() instanceof QubitInformationObject && SecurityPrivileges::editCredentials($sf_user, 'informationObject')) || ($resource->object->getRawValue() instanceof QubitActor && SecurityPrivileges::editCredentials($sf_user, 'actor'))) { ?>
        <tr>

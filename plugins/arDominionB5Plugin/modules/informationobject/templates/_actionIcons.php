  ...
  <ul class="list-unstyled">
    ...
    <li>
      <a href="<?php echo url_for([$resource, 'module' => 'informationobject', 'action' => 'reports']); ?>">
        <i class="fas fa-fw fa-print text-muted" aria-hidden="true"></i>
        <?php echo __('Reports'); ?>
      </a>
    </li>
    ...
    <?php if (InformationObjectInventoryAction::showInventory($resource)) { ?>
      <li>
        <a href="<?php echo url_for([$resource, 'module' => 'informationobject', 'action' => 'inventory']); ?>">
          <i class="fas fa-fw fa-list-alt text-muted" aria-hidden="true"></i>
    ...
    <li>
      ...
      <?php } else { ?>
        <a href="<?php echo url_for([
            ...
            'topLod' => false, ]); ?>">
      <?php } ?>
        <i class="fas fa-fw fa-list text-muted" aria-hidden="true"></i>
    ...
    <ul class="list-unstyled">
      <li>
        <a href="<?php echo url_for([$resource, 'module' => 'object', 'action' => 'importSelect', 'type' => 'xml']); ?>">
          <i class="fas fa-fw fa-download text-muted" aria-hidden="true"></i>
          <?php echo __('XML'); ?>
        </a>
      </li>

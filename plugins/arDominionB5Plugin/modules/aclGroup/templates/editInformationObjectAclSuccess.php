...
<form method="post" action="<?php echo url_for([$resource, 'module' => 'aclGroup', 'action' => 'editInformationObjectAcl']); ?>" id="editForm">

  <?php echo $form->renderHiddenFields(); ?>

  <div class="accordion" id="io-acl">
    <div class="accordion-item">
      ...
      <div id="all-collapse" class="accordion-collapse collapse show" aria-labelledby="all-heading" data-bs-parent="#io-acl">
    ...
    <div class="accordion-item">
      ...
      <div id="io-collapse" class="accordion-collapse collapse" aria-labelledby="io-heading" data-bs-parent="#io-acl">
        <div class="accordion-body">
    ...
    <div class="accordion-item">
      ...
      <div id="repo-collapse" class="accordion-collapse collapse" aria-labelledby="repo-heading" data-bs-parent="#io-acl">
        <div class="accordion-body">
  ...
  <section class="actions">
    <ul>
      <li><?php echo link_to(__('Cancel'), [$resource, 'module' => 'aclGroup', 'action' => 'indexInformationObjectAcl'], ['class' => 'c-btn']); ?></li>

      ...
      <div class="accordion-item">
        <h2 class="accordion-header" id="site-information-heading">
          <button
            ...
            data-bs-target="#site-information-collapse"
            aria-expanded="true"
            aria-controls="site-information-collapse"
          >
            <?php echo __('Site information settings'); ?>
          </button>
        </h2>
        <div id="site-information-collapse"
          class="accordion-collapse collapse show"
          aria-labelledby="site-information-heading"
        >
          <div class="accordion-body">
            <?php echo render_field(
              $form->siteTitle
                  ->label(__('Site title'))
                  ->help(__(
                    'The name of the website for display in the header'
                  )),
              $settings['siteTitle']); ?>
            ...
            <?php echo render_field(
              $form->siteDescription
                  ...
                  ->help(__(
                    'A brief site description or &quot;tagline&quot; for the header'
                  )),
            ...
            <?php echo render_field(
              $form->siteBaseUrl
                  ...
                  ->help(__('Used to create absolute URLs in XML exports')),

...
<?php slot('content'); ?>
  ...
  <?php echo $form->renderFormTag(url_for(['module' => 'settings', 'action' => 'privacyNotification'])); ?>
    ...
    <div class="accordion" id="settings-privacy">
      <div class="accordion-item">
        ...
        <div id="privacy-collapse" class="accordion-collapse collapse show" aria-labelledby="privacy-heading" data-bs-parent="#settings-privacy">

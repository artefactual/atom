        ...
        <div class="digital-object-metadata-body">
          ...
          <?php if ($showMasterFileName) { ?>
            <?php if ($canAccessMasterFile) { ?>
              ...
              <?php } else { ?>
                <?php echo render_show(__('Filename'), link_to(render_value_inline($resource->name), url_for([$resource->object, 'sf_route' => 'preservica_download_master']), ['target' => '_blank']), ['fieldLabel' => 'filename']); ?>
              <?php } ?>
            <?php } else { ?>

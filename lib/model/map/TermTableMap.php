...
class TermTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('CONVERSE_TERM_ID', 'converseTermId', 'INTEGER', 'term', 'ID', false, null, null);
    ...
    $this->addRelation('termRelatedByconverseTermId', 'term', RelationMap::MANY_TO_ONE, array('converse_term_id' => 'id', ), 'SET NULL', null);
    ...
    $this->addRelation('termRelatedByconverseTermId', 'term', RelationMap::ONE_TO_MANY, array('id' => 'converse_term_id', ), 'SET NULL', null);

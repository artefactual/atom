...
class TermTableMap extends TableMap {
    ...
    $this->addRelation('auditLog', 'auditLog', RelationMap::ONE_TO_MANY, array('id' => 'action_type_id', ), 'SET NULL', null);
    ...
    $this->addRelation('functionObjectRelatedBytypeId', 'functionObject', RelationMap::ONE_TO_MANY, array('id' => 'type_id', ), 'SET NULL', null);
    $this->addRelation('functionObjectRelatedBydescriptionStatusId', 'functionObject', RelationMap::ONE_TO_MANY, array('id' => 'description_status_id', ), 'SET NULL', null);
    $this->addRelation('functionObjectRelatedBydescriptionDetailId', 'functionObject', RelationMap::ONE_TO_MANY, array('id' => 'description_detail_id', ), 'SET NULL', null);
    ...
    $this->addRelation('informationObjectRelatedBycollectionTypeId', 'informationObject', RelationMap::ONE_TO_MANY, array('id' => 'collection_type_id', ), 'SET NULL', null);
    ...
    $this->addRelation('relation', 'relation', RelationMap::ONE_TO_MANY, array('id' => 'type_id', ), 'CASCADE', null);

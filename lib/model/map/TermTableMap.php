...
class TermTableMap extends TableMap {
    ...
    $this->addRelation('accessLog', 'accessLog', RelationMap::ONE_TO_MANY, array('id' => 'access_type_id', ), null, null);
    ...
    $this->addRelation('savedQuery', 'savedQuery', RelationMap::ONE_TO_MANY, array('id' => 'type_id', ), 'SET NULL', null);

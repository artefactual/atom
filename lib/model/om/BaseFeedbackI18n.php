...
abstract class BaseFeedbackI18n implements ArrayAccess
{
  const
    DATABASE_NAME = 'propel',

    TABLE_NAME = 'feedback_i18n',

    NAME = 'feedback_i18n.NAME',
    REMARKS = 'feedback_i18n.REMARKS',
	UNIQUE_IDENTIFIER = 'feedback_i18n.UNIQUE_IDENTIFIER',
	ID = 'feedback_i18n.ID',	
    OBJECT_ID = 'feedback_i18n.OBJECT_ID',
    STATUS_ID = 'feedback_i18n.STATUS_ID',
    CREATED_AT = 'feedback_i18n.CREATED_AT',
    COMPLETED_AT = 'feedback_i18n.COMPLETED_AT',
    CULTURE = 'feedback_i18n.CULTURE';

  public static function addSelectColumns(Criteria $criteria)
  {
    $criteria->addSelectColumn(QubitFeedbackI18n::NAME);
    $criteria->addSelectColumn(QubitFeedbackI18n::REMARKS);
	$criteria->addSelectColumn(QubitFeedbackI18n::UNIQUE_IDENTIFIER);
    $criteria->addSelectColumn(QubitFeedbackI18n::ID);
    $criteria->addSelectColumn(QubitFeedbackI18n::OBJECT_ID);
    $criteria->addSelectColumn(QubitFeedbackI18n::CREATED_AT);
    $criteria->addSelectColumn(QubitFeedbackI18n::COMPLETED_AT);
    $criteria->addSelectColumn(QubitFeedbackI18n::STATUS_ID);
    $criteria->addSelectColumn(QubitFeedbackI18n::CULTURE);
  ...
  public static function getFromRow(array $row)
  {
    ...
    $key = serialize($keys);
    if (!isset(self::$feedbackI18ns[$key]))
    {
      $feedbackI18n = new QubitFeedbackI18n;

      $feedbackI18n->keys = $keys;
      $feedbackI18n->row = $row;

      $feedbackI18n->new = false;

      self::$feedbackI18ns[$key] = $feedbackI18n;
    }

    return self::$feedbackI18ns[$key];
  }

  public static function clearCache()
  {
    self::$feedbackI18ns = array();
  }
  ...
  public static function get(Criteria $criteria, array $options = array())
  {
    ...
    {
      $options['connection'] = Propel::getConnection(QubitFeedbackI18n::DATABASE_NAME);
    }

    self::addSelectColumns($criteria);

    return QubitQuery::createFromCriteria($criteria, 'QubitFeedbackI18n', $options);
  }
...
//      return $query[0]->service_provider;
  ...
  public static function getByIdAndCulture($id, $culture, array $options = array())
  {
    $criteria = new Criteria;
    $criteria->add(QubitFeedbackI18n::ID, $id);
    $criteria->add(QubitFeedbackI18n::CULTURE, $culture);
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitFeedbackI18n::DATABASE_NAME)->getTable(QubitFeedbackI18n::TABLE_NAME);
  }
  ...
  protected function rowOffsetGet($name, $offset, $options)
  {
    ...
    if (!array_key_exists($offset, $this->row))
    {
      ...
      $criteria = new Criteria;
      $criteria->add(QubitFeedbackI18n::ID, $this->id);
      $criteria->add(QubitFeedbackI18n::CULTURE, $this->culture);
  ...
  public static function addJoinfeedbackCriteria(Criteria $criteria)
  {
    $criteria->addJoin(QubitFeedbackI18n::ID, QubitFeedback::ID);

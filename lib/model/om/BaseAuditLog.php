...
abstract class BaseAuditLog implements ArrayAccess
{
  const
    ...
    ACTION_TYPE_ID = 'audit_log.ACTION_TYPE_ID',
    CREATED_AT = 'audit_log.CREATED_AT';

  public static function addSelectColumns(Criteria $criteria)
  {
    $criteria->addSelectColumn(QubitAuditLog::ID);
    $criteria->addSelectColumn(QubitAuditLog::OBJECT_ID);
    $criteria->addSelectColumn(QubitAuditLog::USER_ID);
    $criteria->addSelectColumn(QubitAuditLog::USER_NAME);
    $criteria->addSelectColumn(QubitAuditLog::ACTION_TYPE_ID);
    $criteria->addSelectColumn(QubitAuditLog::CREATED_AT);
  ...
  public static function getFromRow(array $row)
  {
    ...
    $key = serialize($keys);
    if (!isset(self::$auditLogs[$key]))
    {
      $auditLog = new QubitAuditLog;
      ...
      self::$auditLogs[$key] = $auditLog;
    }

    return self::$auditLogs[$key];
  }

  public static function clearCache()
  {
    self::$auditLogs = array();
  }
  ...
  public static function get(Criteria $criteria, array $options = array())
  {
    ...
    {
      $options['connection'] = Propel::getConnection(QubitAuditLog::DATABASE_NAME);
    }

    self::addSelectColumns($criteria);

    return QubitQuery::createFromCriteria($criteria, 'QubitAuditLog', $options);
  }
  ...
  public static function getById($id, array $options = array())
  {
    ...
    $criteria->add(QubitAuditLog::ID, $id);
  ...
  {
    $this->tables[] = Propel::getDatabaseMap(QubitAuditLog::DATABASE_NAME)->getTable(QubitAuditLog::TABLE_NAME);
  }
  ...
  protected function rowOffsetGet($name, $offset, $options)
  {
    ...
    if (!array_key_exists($offset, $this->row))
    {
      ...
      $criteria = new Criteria;
      $criteria->add(QubitAuditLog::ID, $this->id);
  ...
  {
    $criteria->addJoin(QubitAuditLog::OBJECT_ID, QubitObject::ID);
  ...
  {
    $criteria->addJoin(QubitAuditLog::USER_ID, QubitUser::ID);

    return $criteria;
  }

  public static function addJoinactionTypeCriteria(Criteria $criteria)
  {
    $criteria->addJoin(QubitAuditLog::ACTION_TYPE_ID, QubitTerm::ID);

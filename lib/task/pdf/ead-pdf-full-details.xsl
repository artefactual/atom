    ...
    <xsl:template match="ead:archdesc" mode="toc">
        <fo:block line-height="18pt" margin-top="0.25in">
            ...
            <fo:block xsl:use-attribute-sets="section">
                ...
                <!-- NOTES HEADING -->
                <xsl:if test="ead:accessrestrict or ead:userestrict or ead:custodhist or ead:accruals or ead:altformavail or ead:acqinfo or ead:processinfo or ead:appraisal or ead:originalsloc or /ead:ead/ead:eadheader/ead:revisiondesc">
                    <fo:block text-align-last="justify">

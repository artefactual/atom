    ...
    $import = new QubitFlatfileImport(array(
      ...
      'postSaveLogic' => function(&$self)
      {
        ...
        if (isset($self->object) && $self->object instanceof QubitAccession && isset($self->object->id))
        {
          ...
          if (!empty($identifiers = $self->rowStatusVars['alternativeIdentifiers']))
          {
            $identifierTypes = (!empty($self->rowStatusVars['alternativeIdentifierTypes']))
              ? $self->rowStatusVars['alternativeIdentifierTypes'] : array();

            $identifierNotes = (!empty($self->rowStatusVars['alternativeIdentifierNotes']))
              ? $self->rowStatusVars['alternativeIdentifierNotes'] : array();

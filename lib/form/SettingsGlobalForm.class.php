...
class SettingsGlobalForm extends sfForm
{
  ...
  public function configure()
  {
    ...
    $this->setWidgets(array(
      ...
      'sort_browser_user' => new sfWidgetFormSelectRadio(array('choices'=>array('alphabetic'=>'alphabetic', 'lastUpdated'=> 'last updated')), array('class'=>'radio')),
      'sort_browser_anonymous' => new sfWidgetFormSelectRadio(array('choices'=>array('alphabetic'=>'alphabetic', 'lastUpdated'=> 'last updated')), array('class'=>'radio')),

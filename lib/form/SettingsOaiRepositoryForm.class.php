...
class SettingsOaiRepositoryForm extends sfForm
{
    ...
    public function configure()
    {
        ...
        // Build widgets
        $this->setWidgets([
            'oai_authentication_enabled' => new sfWidgetFormSelectRadio(['choices' => [1 => 'yes', 0 => 'no']], ['class' => 'radio']),
        ...
        $this->validatorSchema['oai_authentication_enabled'] = new sfValidatorInteger(['required' => false]);
        $this->validatorSchema['oai_repository_code'] = new sfValidatorRegex(['required' => false, 'pattern' => '/^[a-zA-Z0-9]+$/'], ['invalid' => $i18n->__('The code can only contain letters and numbers')]);
        $this->validatorSchema['oai_admin_emails'] = new sfValidatorString(['required' => false]);
        $this->validatorSchema['oai_repository_identifier'] = new sfValidatorString(['required' => false]);
        $this->validatorSchema['sample_oai_identifier'] = new sfValidatorString(['required' => false]);

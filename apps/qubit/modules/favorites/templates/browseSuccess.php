...
<h1><?php echo __('Browse Favorite Items %1%', ['%1%' => sfConfig::get('app_ui_label_cart')]); ?></h1>
  ...
  <thead>
    ...
    <?php foreach ($pager->getResults() as $item) { 	?>
	  <tr class="<?php echo 0 == @++$row % 2 ? 'even' : 'odd'; ?>">
		...
		<td>
			<?php echo link_to('Remove', [$this->resource, 'module' => 'favorites', 'action' => 'removeFavorites', 'id' => $item->id]); ?>
		</td>
	  </tr>
    <?php } ?>
  </tbody>

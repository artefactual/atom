    ...
    $scope.collection = [
      { id: 0, title: 'Play Dead; Real Time', level: 'Work', children: [
            { id: 20, title: 'Components', level: 'Expression', children:
              [
                { id: 31, title: 'DVD', level: 'DigitalObject' },
                { id: 32, title: 'DVD', level: 'DigitalObject' },
                { id: 33, title: 'DVD', level: 'DigitalObject' },
                { id: 34, title: 'Digital Betacam', level: 'DigitalObject' },
                { id: 35, title: 'Digital Betacam', level: 'DigitalObject' },
                { id: 36, title: 'Digital Betacam', level: 'DigitalObject' },

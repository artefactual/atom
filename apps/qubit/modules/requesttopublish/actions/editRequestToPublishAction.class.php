...
class RequestToPublishEditRequestToPublishAction extends DefaultEditAction
{
    ...
    public function execute($request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($this->form->isValid()) {
                $this->processForm();
                if (1 != $this->form->getValue('outcome')) {
                    $this->redirect([$this->resource, 'module' => 'requesttopublish', 'action' => 'browse']);
                }
                $this->resource->save();
                $this->redirect([$this->resource, 'module' => 'requesttopublish', 'action' => 'browse']);
            }
    ...
    protected function addField($name)
    {
        switch ($name) {
            ...
            case 'rtp_planned_use':
                ...
                $this->form->setWidget('rtp_planned_use', new sfWidgetFormTextArea([], ['rows' => 2]));
            ...
            case 'rtp_institution':
                ...
                $this->form->setWidget('rtp_institution', new sfWidgetFormTextArea([], ['rows' => 2]));
            ...
            case 'outcome':
                $choices = ['In review', 'Rejected', 'Approved'];
    ...
    protected function processForm()
    {
        ...
        || null !== $this->form->getValue('rtp_planned_use')) {
            ...
            if (null == $this->form->getValue('rtp_institurion') || '' == $this->form->getValue('rtp_institurion')) {
                $rtp_institurion = '';
            } else {
            ...
            if (null == $this->form->getValue('outcome') || '' == $this->form->getValue('outcome')) {
                $outcome = '';
            } else {

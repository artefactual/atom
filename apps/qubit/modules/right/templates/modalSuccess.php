<form action="/right/post" method="post" role="form">
  ...
  <div class="form-group">
    ...
    <div class="">
      <input type="date" class="" id="startDate" value="<?php echo $right->startDate ?>" placeholder="year-mm-dd">
    </div>

    <label for="endDate" class="control-label">End</label>
    <div class="">
      <input type="date" class="" id="endDate" value="<?php echo $right->endDate ?>" placeholder="year-mm-dd">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="">
      <input type="text" class="" id="rightsNote" value="<?php echo $right->rightsNote ?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="">
      <input type="text" class="" id="rightsHolderId" value="<?php echo $right->rightsHolder->id ?>">
    </div>
  </div>
  ...
  <div class="form-group statute basis-group">
    ...
    <div class="">
      <input type="date" class="" id="determinationDate" value="<?php echo $right->statuteDeterminationDate ?>" placeholder="year-mm-dd">
    </div>
  </div>
...
<script type="text/javascript">
  (function(){
    // hide fields
    jQuery('.basis-group').toggle(false);

    // add event listener for basis select changes
    jQuery('.modal').on('change','select[name="basis"]', function()
    {
      var type = jQuery(this.selectedOptions).text().toLowerCase();
      jQuery('.basis-group').each(function(){
        $this = jQuery(this);

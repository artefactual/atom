      ...
      <fieldset class="collapsible">
        ...
        <?php if ('csv' == $type): ?>
          <div class="form-item">
            ...
            <select name="updateType">
              <option value="importAsNew"><?php echo __('Ignore matches and create new records on import') ?></option>
              <option value="updateMatches"><?php echo __('Update matches ignoring blank fields in CSV') ?></option>
              <option value="deleteMatches"><?php echo __('Delete matches and replace with imported records') ?></option>
            </select>
        ...
        <?php if ('csv' != $type): ?>
          <div class="form-item">
            ...
            <label><?php echo __('Update behaviours') ?></label>
            <select name="updateType">
              <option value="importAsNew"><?php echo __('Ignore matches and import as new') ?></option>
              <option value="deleteMatches"><?php echo __('Delete matches and replace with imports') ?></option>
            </select>
          </div>
        <?php endif; ?>
